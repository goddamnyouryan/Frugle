class ApplicationController < ActionController::Base
  ...
  def map_marker
    ...
    @map.icon_global_init( GIcon.new(:image => "images/food.png",:icon_size => GSize.new(30,30),:icon_anchor => GPoint.new(9,32),:info_window_anchor => GPoint.new(9,2), :info_shadow_anchor => GPoint.new(18,25)), "restaurants")
